...
@section('content')
    <div class="card mb-4">
        <h1 class="ms-3 my-3">
            <a href="{{ route('admin.orders') }}" class="btn btn-dark"><</a>
            Code transaksi <span class="text-info">#{{ $transactions->id }}</span></h1>
        <div class="card-body row">
            <div class="col-md-4">

                    <img src="{{ asset('/') }}{{ get_image_category($transactions->event->image_path) }}" class="card-img-top" alt="..." height="340">
            ...
            <div class="col-md-8">
                ...
                <table class="table">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="">
                            <a href="{{ asset('storage/' . $transactions->bukti_bayar) }}" target="_blank" class="btn btn-info">
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td>
                            <form action="{{ route('orders.update', ['order' => $transactions->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
                        ...
                        <td>:</td>
                        <td>
                            <form action="{{ route('orders.update.refund', ['order' => $transactions->id]) }}" method="POST">
                                @csrf
                                @method('PUT')
